...
@interface QNWhiteBoardExpandableToolbar()
{
    ...
    QNSelectResourceViewController * resourceVC;
}
@end
...
-(void)popSelectResourceView
{
    if(resourceVC == nil)
    {
        resourceVC = [[QNSelectResourceViewController alloc] initWithNibName:@"QNSelectResourceViewController" bundle:[NSBundle bundleForClass:[QNSelectResourceViewController class]]];
